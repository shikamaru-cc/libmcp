...
static McpToolCallResult* get_new_stories_handler(cJSON* params)
{
    int limit = 20;
    cJSON* limit_json = cJSON_Select(params, ".limit:n");
    if (limit_json) {
    ...
    return fetch_stories("newstories.json", limit);
}

static McpTool tool_get_new_stories = {
    .name = "get_new_stories",
    .description = "Get new stories from HackerNews",
    .handler = get_new_stories_handler,
    .input_schema = {
        .type = MCP_INPUT_SCHEMA_TYPE_OBJECT,
        .properties = tool_get_stories_schema,
    },
...
static McpToolCallResult* get_best_stories_handler(cJSON* params)
{
    int limit = 20;
    cJSON* limit_json = cJSON_Select(params, ".limit:n");
    if (limit_json) {
    ...
    return fetch_stories("beststories.json", limit);
}

static McpTool tool_get_best_stories = {
    .name = "get_best_stories",
    .description = "Get best stories from HackerNews",
    .handler = get_best_stories_handler,
    .input_schema = {
        .type = MCP_INPUT_SCHEMA_TYPE_OBJECT,
        .properties = tool_get_stories_schema,
    },
...
static McpToolCallResult* get_show_stories_handler(cJSON* params)
{
    int limit = 20;
    cJSON* limit_json = cJSON_Select(params, ".limit:n");
    if (limit_json) {
    ...
    return fetch_stories("showstories.json", limit);
}

static McpTool tool_get_show_stories = {
    .name = "get_show_stories",
    .description = "Get Show HN stories from HackerNews",
    .handler = get_show_stories_handler,
    .input_schema = {
        .type = MCP_INPUT_SCHEMA_TYPE_OBJECT,
        .properties = tool_get_stories_schema,
    },
...
static McpToolCallResult* get_job_stories_handler(cJSON* params)
{
    int limit = 20;
    cJSON* limit_json = cJSON_Select(params, ".limit:n");
    if (limit_json) {
    ...
    return fetch_stories("jobstories.json", limit);
}

static McpTool tool_get_job_stories = {
    .name = "get_job_stories",
    .description = "Get job stories from HackerNews",
    .handler = get_job_stories_handler,
    .input_schema = {
        .type = MCP_INPUT_SCHEMA_TYPE_OBJECT,
        .properties = tool_get_stories_schema,
    },
